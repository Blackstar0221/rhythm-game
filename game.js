...
function getPatterns(level) {
    ...
    const normal = [
        [L, L+250, L+500, L+1000, L+1500],
        [L, L+500, L+750, L+1000, L+1500],
        [L, L+250, L+750, L+1000, L+1500],
        [L, L+500, L+1000, L+1250, L+1500, L+2000],
        [L, L+250, L+500, L+1000, L+1250, L+1500],
        [L, L+500, L+750, L+1250, L+1500, L+2000],
    ];
    const hard = [
        [L, L+250, L+500, L+750, L+1000, L+1500],
        [L, L+250, L+750, L+1000, L+1250, L+1500, L+2000],
        [L, L+250, L+500, L+750, L+1250, L+1500, L+1750],
        [L, L+250, L+500, L+1000, L+1250, L+1500, L+1750, L+2000],
        [L, L+375, L+750, L+1000, L+1375, L+1750, L+2000],
        [L, L+250, L+500, L+750, L+1000, L+1250, L+1500],
    ];
...
const game = {
    ...
    start() {
        ...
        const cfg = {
            easy:   { rounds: 6,  pW: 180, gW: 350 },
            normal: { rounds: 8,  pW: 140, gW: 280 },
            hard:   { rounds: 10, pW: 100, gW: 220 },
        }[this.level];
